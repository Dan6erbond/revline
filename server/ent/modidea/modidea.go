...
const (
	// Label holds the string label denoting the modidea type in the database.
	Label = "mod_idea"
	...
	// Table holds the table name of the modidea in the database.
	Table = "mod_ideas"
	...
	CarColumn = "car_mod_ideas"
	// TasksTable is the table that holds the tasks relation/edge. The primary key declared below.
	TasksTable = "task_mod_ideas"
	...
	ProductOptionsColumn = "mod_idea_product_options"
)

// Columns holds all SQL columns for modidea fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "mod_ideas"
...
var (
	...
	TasksPrimaryKey = []string{"task_id", "mod_idea_id"}
)
...
func CategoryValidator(c Category) error {
	...
	case CategoryPerformance, CategoryAesthetic, CategoryUtility:
		return nil
	default:
		return fmt.Errorf("modidea: invalid enum value for category field: %q", c)
	}
}

// OrderOption defines the ordering options for the ModIdea queries.
