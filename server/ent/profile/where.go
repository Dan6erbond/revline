...
func CurrencyCode(v string) predicate.Profile {
	return predicate.Profile(sql.FieldEQ(FieldCurrencyCode, v))
}
...
func CurrencyCodeEQ(v string) predicate.Profile {
	return predicate.Profile(sql.FieldEQ(FieldCurrencyCode, v))
}

// CurrencyCodeNEQ applies the NEQ predicate on the "currency_code" field.
func CurrencyCodeNEQ(v string) predicate.Profile {
	return predicate.Profile(sql.FieldNEQ(FieldCurrencyCode, v))
}

// CurrencyCodeIn applies the In predicate on the "currency_code" field.
func CurrencyCodeIn(vs ...string) predicate.Profile {
	return predicate.Profile(sql.FieldIn(FieldCurrencyCode, vs...))
}

// CurrencyCodeNotIn applies the NotIn predicate on the "currency_code" field.
func CurrencyCodeNotIn(vs ...string) predicate.Profile {
	return predicate.Profile(sql.FieldNotIn(FieldCurrencyCode, vs...))
}

// CurrencyCodeGT applies the GT predicate on the "currency_code" field.
func CurrencyCodeGT(v string) predicate.Profile {
	return predicate.Profile(sql.FieldGT(FieldCurrencyCode, v))
}

// CurrencyCodeGTE applies the GTE predicate on the "currency_code" field.
func CurrencyCodeGTE(v string) predicate.Profile {
	return predicate.Profile(sql.FieldGTE(FieldCurrencyCode, v))
}

// CurrencyCodeLT applies the LT predicate on the "currency_code" field.
func CurrencyCodeLT(v string) predicate.Profile {
	return predicate.Profile(sql.FieldLT(FieldCurrencyCode, v))
}

// CurrencyCodeLTE applies the LTE predicate on the "currency_code" field.
func CurrencyCodeLTE(v string) predicate.Profile {
	return predicate.Profile(sql.FieldLTE(FieldCurrencyCode, v))
}

// CurrencyCodeContains applies the Contains predicate on the "currency_code" field.
func CurrencyCodeContains(v string) predicate.Profile {
	return predicate.Profile(sql.FieldContains(FieldCurrencyCode, v))
}

// CurrencyCodeHasPrefix applies the HasPrefix predicate on the "currency_code" field.
func CurrencyCodeHasPrefix(v string) predicate.Profile {
	return predicate.Profile(sql.FieldHasPrefix(FieldCurrencyCode, v))
}

// CurrencyCodeHasSuffix applies the HasSuffix predicate on the "currency_code" field.
func CurrencyCodeHasSuffix(v string) predicate.Profile {
	return predicate.Profile(sql.FieldHasSuffix(FieldCurrencyCode, v))
}

// CurrencyCodeIsNil applies the IsNil predicate on the "currency_code" field.
func CurrencyCodeIsNil() predicate.Profile {
	return predicate.Profile(sql.FieldIsNull(FieldCurrencyCode))
}

// CurrencyCodeNotNil applies the NotNil predicate on the "currency_code" field.
func CurrencyCodeNotNil() predicate.Profile {
	return predicate.Profile(sql.FieldNotNull(FieldCurrencyCode))
}

// CurrencyCodeEqualFold applies the EqualFold predicate on the "currency_code" field.
func CurrencyCodeEqualFold(v string) predicate.Profile {
	return predicate.Profile(sql.FieldEqualFold(FieldCurrencyCode, v))
}

// CurrencyCodeContainsFold applies the ContainsFold predicate on the "currency_code" field.
func CurrencyCodeContainsFold(v string) predicate.Profile {
	return predicate.Profile(sql.FieldContainsFold(FieldCurrencyCode, v))
}

// FuelVolumeUnitEQ applies the EQ predicate on the "fuel_volume_unit" field.
func FuelVolumeUnitEQ(v FuelVolumeUnit) predicate.Profile {
	return predicate.Profile(sql.FieldEQ(FieldFuelVolumeUnit, v))
}

// FuelVolumeUnitNEQ applies the NEQ predicate on the "fuel_volume_unit" field.
func FuelVolumeUnitNEQ(v FuelVolumeUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNEQ(FieldFuelVolumeUnit, v))
}

// FuelVolumeUnitIn applies the In predicate on the "fuel_volume_unit" field.
func FuelVolumeUnitIn(vs ...FuelVolumeUnit) predicate.Profile {
	return predicate.Profile(sql.FieldIn(FieldFuelVolumeUnit, vs...))
}

// FuelVolumeUnitNotIn applies the NotIn predicate on the "fuel_volume_unit" field.
func FuelVolumeUnitNotIn(vs ...FuelVolumeUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNotIn(FieldFuelVolumeUnit, vs...))
}

// FuelVolumeUnitIsNil applies the IsNil predicate on the "fuel_volume_unit" field.
func FuelVolumeUnitIsNil() predicate.Profile {
	return predicate.Profile(sql.FieldIsNull(FieldFuelVolumeUnit))
}

// FuelVolumeUnitNotNil applies the NotNil predicate on the "fuel_volume_unit" field.
func FuelVolumeUnitNotNil() predicate.Profile {
	return predicate.Profile(sql.FieldNotNull(FieldFuelVolumeUnit))
}

// DistanceUnitEQ applies the EQ predicate on the "distance_unit" field.
func DistanceUnitEQ(v DistanceUnit) predicate.Profile {
	return predicate.Profile(sql.FieldEQ(FieldDistanceUnit, v))
}

// DistanceUnitNEQ applies the NEQ predicate on the "distance_unit" field.
func DistanceUnitNEQ(v DistanceUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNEQ(FieldDistanceUnit, v))
}

// DistanceUnitIn applies the In predicate on the "distance_unit" field.
func DistanceUnitIn(vs ...DistanceUnit) predicate.Profile {
	return predicate.Profile(sql.FieldIn(FieldDistanceUnit, vs...))
}

// DistanceUnitNotIn applies the NotIn predicate on the "distance_unit" field.
func DistanceUnitNotIn(vs ...DistanceUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNotIn(FieldDistanceUnit, vs...))
}

// DistanceUnitIsNil applies the IsNil predicate on the "distance_unit" field.
func DistanceUnitIsNil() predicate.Profile {
	return predicate.Profile(sql.FieldIsNull(FieldDistanceUnit))
}

// DistanceUnitNotNil applies the NotNil predicate on the "distance_unit" field.
func DistanceUnitNotNil() predicate.Profile {
	return predicate.Profile(sql.FieldNotNull(FieldDistanceUnit))
}

// FuelConsumptionUnitEQ applies the EQ predicate on the "fuel_consumption_unit" field.
func FuelConsumptionUnitEQ(v FuelConsumptionUnit) predicate.Profile {
	return predicate.Profile(sql.FieldEQ(FieldFuelConsumptionUnit, v))
}

// FuelConsumptionUnitNEQ applies the NEQ predicate on the "fuel_consumption_unit" field.
func FuelConsumptionUnitNEQ(v FuelConsumptionUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNEQ(FieldFuelConsumptionUnit, v))
}

// FuelConsumptionUnitIn applies the In predicate on the "fuel_consumption_unit" field.
func FuelConsumptionUnitIn(vs ...FuelConsumptionUnit) predicate.Profile {
	return predicate.Profile(sql.FieldIn(FieldFuelConsumptionUnit, vs...))
}

// FuelConsumptionUnitNotIn applies the NotIn predicate on the "fuel_consumption_unit" field.
func FuelConsumptionUnitNotIn(vs ...FuelConsumptionUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNotIn(FieldFuelConsumptionUnit, vs...))
}

// FuelConsumptionUnitIsNil applies the IsNil predicate on the "fuel_consumption_unit" field.
func FuelConsumptionUnitIsNil() predicate.Profile {
	return predicate.Profile(sql.FieldIsNull(FieldFuelConsumptionUnit))
}

// FuelConsumptionUnitNotNil applies the NotNil predicate on the "fuel_consumption_unit" field.
func FuelConsumptionUnitNotNil() predicate.Profile {
	return predicate.Profile(sql.FieldNotNull(FieldFuelConsumptionUnit))
}

// TemperatureUnitEQ applies the EQ predicate on the "temperature_unit" field.
func TemperatureUnitEQ(v TemperatureUnit) predicate.Profile {
	return predicate.Profile(sql.FieldEQ(FieldTemperatureUnit, v))
}

// TemperatureUnitNEQ applies the NEQ predicate on the "temperature_unit" field.
func TemperatureUnitNEQ(v TemperatureUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNEQ(FieldTemperatureUnit, v))
}

// TemperatureUnitIn applies the In predicate on the "temperature_unit" field.
func TemperatureUnitIn(vs ...TemperatureUnit) predicate.Profile {
	return predicate.Profile(sql.FieldIn(FieldTemperatureUnit, vs...))
}

// TemperatureUnitNotIn applies the NotIn predicate on the "temperature_unit" field.
func TemperatureUnitNotIn(vs ...TemperatureUnit) predicate.Profile {
	return predicate.Profile(sql.FieldNotIn(FieldTemperatureUnit, vs...))
}

// TemperatureUnitIsNil applies the IsNil predicate on the "temperature_unit" field.
func TemperatureUnitIsNil() predicate.Profile {
	return predicate.Profile(sql.FieldIsNull(FieldTemperatureUnit))
}

// TemperatureUnitNotNil applies the NotNil predicate on the "temperature_unit" field.
func TemperatureUnitNotNil() predicate.Profile {
