...
func (ec *executionContext) unmarshalInputCreateCarInput(ctx context.Context, obj any) (ent.CreateCarInput, error) {
	...
	fieldsInOrder := [...]string{"createTime", "updateTime", "name", "make", "model", "type", "year", "trim", "ownerID", "dragSessionIDs", "fuelUpIDs", "odometerReadingIDs", "serviceItemIDs", "serviceLogIDs", "serviceScheduleIDs", "mediumIDs", "bannerImageID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputCreateProfileInput(ctx context.Context, obj any) (ent.CreateProfileInput, error) {
	...
	fieldsInOrder := [...]string{"createTime", "updateTime", "username", "firstName", "lastName", "currencyCode", "fuelVolumeUnit", "distanceUnit", "fuelConsumptionUnit", "temperatureUnit", "visibility", "userID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateProfileInput(ctx context.Context, obj any) (ent.UpdateProfileInput, error) {
	...
	fieldsInOrder := [...]string{"updateTime", "username", "clearUsername", "firstName", "clearFirstName", "lastName", "clearLastName", "currencyCode", "clearCurrencyCode", "fuelVolumeUnit", "clearFuelVolumeUnit", "distanceUnit", "clearDistanceUnit", "fuelConsumptionUnit", "clearFuelConsumptionUnit", "temperatureUnit", "clearTemperatureUnit", "visibility", "userID"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
